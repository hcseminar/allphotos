(function (root, factory) {
    ...
    var AppClient = function () {
        _.bindAll(this, "_initializationFilter", "_secureProjectFilter", "init", "isInitialized",
            ...
            "login", "logout", "isUserLoggedIn", "_isUserLoggedInSync", "dao", "folder",
            "isOffline", "isOnline",
        ...
        var APPCLIENT_FUNCTIONS_LIST_TO_WRAP_WITH_INIT_FILER = [
            ...
            "isUserLoggedIn", "dao", "folder", "invoke", "post", "get", "setSessionToken",
        ...
        var APPCLIENT_SECURE_FUNCTIONS_LIST = [
            ...
            "dao", "folder", "setCustomModel", "removeCustomModel", "logout", "invoke", "getDeferredActions",
            ...
            .then(function () {
                if(this.settings.handleNetworkState){
                    ...
                    return Q.Promise(function (resolve, reject) {
                        ...
                        Offline.init();
                        var initialStateDetectionHandler = function (state) {
    ...
    AppClient.prototype.initDAOOnline = function (modelName) {
        if (_.isArray(modelName)) {
            ...
            for (var i = 0, j = modelName.length; i < j; i++) {
                promise = promise.then(_.partial(this.initDAOOnline, modelName[i]));
            }
            return promise;
        } else {
    ...
    AppClient.prototype.initDAOOffline = function (modelName, isCustomModel) {
        if (_.isArray(modelName)) {
            ...
            var promise = Q();
            for (var i = 0, j = modelName.length; i < j; i++) {
                promise = promise.then(_.partial(this.initDAOOffline, modelName[i], isCustomModel));
            }
            return promise;
        } else {
    ...
    AppClient.prototype.login = function (username, password, token, options){var promise;
        var promise;
    ...
    AppClient.prototype._updateAutoLoginData = function (strategy) {
        ...
        if(this._isAutoLoginActivated() && !_.isUndefined(this._currentUser) && !_.isNull(this._currentUser)){
            ...
            return Q.fcall(function(){
                localforage.setItem(this._autoLoginStorageKey, autoLoginData);
            }.bind(this));
        }else{
            return this._clearAutoLoginData();
        }
    ...
    AppClient.prototype._clearAutoLoginData = function () {
        ...
        return Q.fcall(function(){
            localforage.removeItem(this._autoLoginStorageKey);
        }.bind(this));
    };
    ...
    AppClient.prototype._getLastSyncDateForModel = function(modelName) {
        ...
        return Q.Promise(function (resolve, reject) {
            localforage.getItem(lastSyncDateKey, function (err, value) {
                if (err) {
                    reject(err);
                } else {
                    resolve(value);
    ...
    AppClient.prototype._setLastSyncDateForModel = function(modelName, lastSyncDate) {
        var lastSyncDateKey = "data-sync-last-date-model-"+modelName;
        return Q(localforage.setItem(lastSyncDateKey, lastSyncDate));
    };
...
// Entity DAO
        ...
        return Q.Promise(function (resolve, reject) {
            ...
            .then(function () {
                if(this._isTwoWaySyncActivated()){
                    ...
                    deletedNotTrueCriteria[this.meta.deletedAttribute] = {"$ne": true};
                    if(this.deletedFieldType === "number"){
                        deletedNotTrueCriteria[this.meta.deletedAttribute] = {"$eq": 0};
                    }
                ...
                promise = promise.then(function(data) {
                    ...
                    return this.store.set(data).then(function(){
                        if(this._isTwoWaySyncActivated()) {
                            ...
                            if(this._getDeletedFieldValue(action.content.data)){
    ...
    EntityDAO.prototype.find = function (where, options) {
        ...
        if (!_.isUndefined(options.sort) && !_.isEmpty(options.sort)) {
...
// Entity storage
    ...
    EntityStorage.prototype.init = function () {
        return this.localForageInst.length().then(function () {
            //initialization success
        });
    }
